...
import com.project.citysearchedemo.bean.NameBean;
 ...
 * 文件名:    SectionDecoration
 * 创建者:    hello
 * 创建时间:  2016/12/9 14:59
 * 描述:      TODO
 */
public class SectionDecoration extends RecyclerView.ItemDecoration {    private static final String TAG = "SectionDecoration";
    ...
    public SectionDecoration(List<NameBean> dataList, Context context, DecorationCallback decorationCallback) {
        ...
        //设置悬浮栏的画笔---paint
        paint = new Paint();
        paint.setColor(res.getColor(R.color.light_gray));
        //设置悬浮栏中文本的画笔
